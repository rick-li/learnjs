    ...
    Socket.prototype.connect = function(fn) {
      ...
      this.handshake(function(sid, heartbeat, close, transports) {
        ...
        self.once('connect', function() {
          console.log('Connected to ', self.transport.name);
...
*/
  ...
  (function(exports, io) {
    ...
    HTMLFile.prototype.get = function() {
      ...
      var activeX = ['Active'].concat('Object').join('X');
      this.doc = document;
      if (window[activeX]) { //For IE only, no loading cycle.
        this.doc = new window[activeX]('htmlfile');
        this.doc.open();
